...
- Owns: `projects/<slug>/PM/` (or repo-root `PM/` for the template) --
  `PM/README.md` charter plus `Stakeholders.md`, `Milestones.md`, `Risks.md`,
...
4. Re-read; surface gaps, contradictions, unstated assumptions; ask a follow-up
   batch. Keep unresolved items as open questions in `PM/Issues.md` -- do not
   invent answers.
...
statement, package/domain list, known constraints, stakeholder/owner list.
